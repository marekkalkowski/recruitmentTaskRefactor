...
@Repository
@Transactional
public class GroupToResourceDaoDaoImpl implements GroupToResourceDao<PermissionGroup, Resource> {

    public static final Logger LOG = LogManager.getLogger(GroupToResourceDaoDaoImpl.class);
